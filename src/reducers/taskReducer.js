...
export default function taskReducer(state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case types.UPDATE_TASK_SUCCESS:
            const indexOfTaskToUpdate = state.tasks.findIndex(task => { return task._id === action.task._id });
        ...
        case types.DELETE_TASK_SUCCESS: {
            ...
            const indexOfTaskToDelete = state.tasks.findIndex(task => { return task._id === action.task._id });
